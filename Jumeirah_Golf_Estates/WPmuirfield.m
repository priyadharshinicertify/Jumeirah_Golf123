...
@interface WPmuirfield ()

@end

@implementation WPmuirfield
...
- (void)loadView {
    ...
    NSString *post1 =[[NSString alloc] initWithFormat:@"district_id=jge-wp&feature_id=jge-fp&floorplan_id=jge-fp-mf"];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.screenName = @"WPmuirfield Screen";
}
