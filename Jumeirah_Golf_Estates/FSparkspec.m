...
-(void)getcontactdetails
{
    ...
    NSString *post =[[NSString alloc] initWithFormat:@"district_id=jge-fs&feature_id=jge-rp&redwood_park_id=jge-rp-spec"];
