...
#import "RESideMenu.h"
@interface FTinverness ()

@end

@implementation FTinverness
...
- (void)loadView {
    ...
    NSString *post1 =[[NSString alloc] initWithFormat:@"district_id=jge-ftr&feature_id=jge-fp&floorplan_id=jge-fp-in"];
