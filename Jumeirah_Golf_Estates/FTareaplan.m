...
@interface FTareaplan ()

@end

@implementation FTareaplan
...
- (void)loadView {
    ...
    NSString *post1 =[[NSString alloc] initWithFormat:@"district_id=jge-ftr&feature_id=jge-fp&floorplan_id=jge-ftr-ap"];
