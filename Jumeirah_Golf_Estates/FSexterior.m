...
@interface FSexterior ()

@end

@implementation FSexterior
...
- (void)loadView {
    ...
    NSString *post1 =[[NSString alloc] initWithFormat:@"district_id=jge-fs&feature_id=jge-rp&redwood_park_id=jge-rp-ext"];
