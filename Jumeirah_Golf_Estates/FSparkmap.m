...
-(void)getcontactdetails
{
    ...
    NSString *post =[[NSString alloc] initWithFormat:@"district_id=jge-fs&feature_id=jge-rp&redwood_park_id=jge-rp-map"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.des.text =(self.itemshowdetailsAr)[indexPath.row][@"title"]; //title(self.itemshowdetailsAr)[indexPath.row][@"description"];
    cell.txt.text=@"JGE-Golf estates";  //(self.itemshowdetailsAr)[indexPath.row][@"title"];
