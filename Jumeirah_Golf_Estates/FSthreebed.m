...
#import "FSthreebed.h"
#import "RESideMenu.h"
@interface FSthreebed ()

@end

@implementation FSthreebed
...
- (void)loadView {
    ...
    NSString *post1 =[[NSString alloc] initWithFormat:@"district_id=jge-fs&feature_id=jge-rp&redwood_park_id=jge-rp-int-3b"];
