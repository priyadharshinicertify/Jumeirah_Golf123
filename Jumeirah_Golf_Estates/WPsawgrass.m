...
#import "WPsawgrass.h"
#import "imagecell.h"
//#import "WPsawgrassimage.h"
#import "RESideMenu.h"
@interface WPsawgrass ()

@end

@implementation WPsawgrass
...
- (void)loadView {
    ...
    NSString *post1 =[[NSString alloc] initWithFormat:@"district_id=jge-wp&feature_id=jge-fp&floorplan_id=jge-fp-sg"];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.screenName = @"Wpsawgrass Screen";
}
