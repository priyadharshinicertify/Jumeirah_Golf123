...
#import "RESideMenu.h"
@interface WPtimeless ()


@end

@implementation WPtimeless
...
- (void)loadView {
    ...
    NSString *post1 =[[NSString alloc] initWithFormat:@"district_id=jge-wp&feature_id=jge-it&interior_id=jge-it-tl"];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.screenName = @"WPtimeless Screen";
}
