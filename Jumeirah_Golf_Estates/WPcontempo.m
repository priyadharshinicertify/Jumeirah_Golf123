...
#import "RESideMenu.h"
@interface WPcontempo ()

@end

@implementation WPcontempo
...
- (void)loadView {
    ...
    NSString *post1 =[[NSString alloc] initWithFormat:@"district_id=jge-wp&feature_id=jge-it&interior_id=jge-it-co"];
    NSData *postData1 = [post1 dataUsingEncoding:NSASCIIStringEncoding allowLossyConversion:YES];
    
    NSLog(@"postData.....%@", post1);
    NSString *URL1 = [NSString stringWithFormat:@"http://mobileapp.jumeirahgolfestates.org/jumeirah/property_showcase4.php"];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.screenName = @"WPcontempo Screen";
}
