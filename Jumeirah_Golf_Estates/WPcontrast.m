...
#import "RESideMenu.h"
@interface WPcontrast ()

@end

@implementation WPcontrast
...
- (void)loadView {
    ...
    NSString *post1 =[[NSString alloc] initWithFormat:@"district_id=jge-wp&feature_id=jge-it&interior_id=jge-it-ct"];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.screenName = @"WPContrast Screen";
}
