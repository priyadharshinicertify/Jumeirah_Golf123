...
@interface maintancepopview ()
@property (nonatomic, strong) NSArray *arrAgeRanges;

@end

@implementation maintancepopview
...
- (void)viewDidLoad
{
    ...
    self.arrAgeRanges = [[NSArray alloc] initWithObjects:@"Redwood", @"Flame Tree Ridge",@"Lime Tree Valley East", @"Lime Tree Valley West", @"Olive Point", @"Wishpering Pines", @"Wild Flower",@"Sienna Lakes",@"Sanctuary Falls",@"Other", nil];
