...
@interface FToverview ()<UITableViewDataSource, UITableViewDelegate>
{
    singleton *manage;
}
...
@implementation FToverview
@synthesize itemshowdetailsAr,dataArray,collectionViewPack,itemshowdetailsAr1;
- (void)viewDidLoad
{
    [super viewDidLoad];
...
- (void)configureDataSource
{
    ...
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://mobileapp.jumeirahgolfestates.org/jumeirah/property_showcase3.php"]] ];
    NSString *requestString = [NSString stringWithFormat:@"district_id=jge-ftr"];
...
{
    if ([manage.flameover isEqualToString:@"hello"]) {
        manage.flameover=@"";
    }
    else
    {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([object isKindOfClass:[RZCellData class]])
    {
        ...
        cell.l1.textColor=[UIColor colorWithRed:(255/255.0) green:(167/255.0) blue:(18/255.0) alpha:1];
