...
typedef enum
{
	FGalleryPhotoSizeThumbnail1,
	FGalleryPhotoSizeFullsize1
} FGalleryPhotoSize1;

typedef enum
{
	FGalleryPhotoSourceTypeNetwork1,
	FGalleryPhotoSourceTypeLocal1
} FGalleryPhotoSourceType1;

@protocol FGalleryViewControllerDelegate;

@interface FGalleryViewController1 : UIViewController<UIScrollViewDelegate,FGalleryPhotoDelegate,FGalleryPhotoViewDelegate> {
...
@optional
- (NSString*)photoGallery:(FGalleryViewController1*)gallery captionForPhotoAtIndex:(NSUInteger)index;
