...
-(void)getcontactdetails
{
    ...
    NSString *post =[[NSString alloc] initWithFormat:@"district_id=jge-fs&feature_id=jge-ra&redwood_avenue_id=jge-ra-map"];
