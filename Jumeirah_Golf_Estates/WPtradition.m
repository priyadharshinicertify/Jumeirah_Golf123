...
@interface WPtradition ()

@end

@implementation WPtradition
...
- (void)loadView {
    ...
    NSString *post1 =[[NSString alloc] initWithFormat:@"district_id=jge-wp&feature_id=jge-it&interior_id=jge-it-td"];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.screenName = @"WPtradition Screen";
}
