...
@interface FTtradition ()

@end

@implementation FTtradition
...
- (void)loadView {
    ...
    NSString *post1 =[[NSString alloc] initWithFormat:@"district_id=jge-ftr&feature_id=jge-it&interior_id=jge-it-tr"];
