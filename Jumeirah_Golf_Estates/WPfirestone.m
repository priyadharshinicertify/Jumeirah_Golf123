...
@interface WPfirestone ()

@end

@implementation WPfirestone
...
- (void)loadView {
    ...
    NSString *post1 =[[NSString alloc] initWithFormat:@"district_id=jge-wp&feature_id=jge-fp&floorplan_id=jge-fp-fs"];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.screenName = @"WPfirestone Screen";
}
