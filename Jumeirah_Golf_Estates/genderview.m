...
- (void)viewDidLoad
{
    ...
    self.arrAgeRanges = [[NSArray alloc] initWithObjects:@"Male",@"Female", nil];
...
- (IBAction)done:(id)sender {
    [self.delegate genderviewpro:[self.arrAgeRanges objectAtIndex:[self.pickerAge selectedRowInComponent:0]] ];
}

- (IBAction)cancel:(id)sender
{
    [self.delegate genderviewpro1];
}
